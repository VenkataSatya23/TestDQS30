namespace GasStationSample.CommerceRuntime
{
    ...
    public class GasPumpsDataService : IRequestHandlerAsync
    {
        ...
        private static Dictionary<string, IEnumerable<CustomerEntity>> Customer;
        ...
        public IEnumerable<Type> SupportedRequestTypes
        {
            get
            {
                return new[]
                {
                    typeof(UpdateCustomerDataRequest),
        ...
        public async Task<Response> Execute(Request request)
        {
            ...
            if (reqType == typeof(UpdateCustomerDataRequest))
            {
                return this.updateCustomerdetails((UpdateCustomerDataRequest)request);
            }
            else if (reqType == typeof(GetCustomerDataRequest))
            {
                return this.getCustomerdetails((GetCustomerDataRequest)request);
            }
            else if (reqType == typeof(GetGasPumpsDataRequest))
            {
        ...
        private Response updateCustomerdetails(UpdateCustomerDataRequest request)
        {
            
            var customer = GasPumpsDataService.Customer[""];
            return new UpdateCustomerDataResponse("ok");
        }
        private Response getCustomerdetails(GetCustomerDataRequest request)
        {
            
            var customer = GasPumpsDataService.Customer[""];
            return new GetCustomerDataResponse(customer);
        }
        private Response insertCustomerdetails(GetCustomerDataRequest request)
        {
